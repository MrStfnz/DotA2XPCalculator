...
def calculate_target(curlvl, targetlvl, win_points, loss_points, win_perc):
    required_points = [50, 350, 750, 1250, 1850, 2750, 3750, 4850, 6050, 7350, 8750, 10450,
                       12250, 14150, 16150, 18250, 20450, 22950, 25550, 28250, 31050, 33950,
                       36950, 40050, 46850, 50850, 55050, 59450, 64050, 72050]
